 ...
 */
class Version20180419073218 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post RENAME INDEX fk_5a8a6c8d12469de2 TO fk_post_category_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post RENAME INDEX fk_post_category_id TO FK_5A8A6C8D12469DE2');
    }
}
